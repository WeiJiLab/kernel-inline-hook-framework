...
int init_write_map_page(void)
{
    ...
    _stext_ptr = (void *)find_sym("_stext");
    _etext_ptr = (void *)find_sym("_etext");
    _sinittext_ptr = (void *)find_sym("_sinittext");
    _einittext_ptr = (void *)find_sym("_einittext");
    core_kernel_text_ptr = (void *)prep_callfunc("core_kernel_text");
    is_module_text_address_ptr = (void *)prep_callfunc("is_module_text_address");
